...
document.getElementById("generate-button").addEventListener("click", function () {
  ...
  if (jobSelected !== "Select Option" && skillsSelected !== "Select Option") {
    // Dynamically set iframe source if needed
    iframe.src = "your_actual_path_here.html"; // Replace with your actual link or path
    ...
    // Ensure roadmap section is displayed
    roadmapSection.style.display = "block";  // Ensure the roadmap section is visible
  } else {
